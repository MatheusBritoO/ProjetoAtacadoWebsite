 ...
 function AcionarInclusao() {
     ...
     $.ajax({
        ...
        success: function(data){
            alert('Categoria salva com sucesse (ID:' + data.codigo +').');
            Cancelar();
        } 
     });       
     }
     ...
     function AcionarAlteracao(){
       ...
       categoria.codigo = $('#txtID').val();
        ...
        $.ajax({
           ...
           contentType: 'application/json',
           success: function(data){
               alert('Categoria alterada com sucesse (ID:' + data.codigo +').');
               Cancelar();
           } 
        });       
     }
     ...
     function AcionarExclusao(){
        var id = localStorage.getItem('opercatid');
         ...
         $.ajax({
            ...
            contentType: 'application/json',
            success: function(data){
                alert('Categoria excluida com sucesso (ID:' + data.codigo +').');
                Cancelar();
            } 
         });       
     }